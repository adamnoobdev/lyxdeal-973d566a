...
const DealCardComponent = ({
  ...
  return (
    <Card className="group relative overflow-hidden transition-all duration-500 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1 bg-gradient-to-br from-white via-accent/5 to-accent/10 border border-accent/20">
