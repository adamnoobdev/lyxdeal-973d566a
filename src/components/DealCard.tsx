...
const DealCardComponent = ({
  ...
  return (
    <Card className="group h-full flex flex-col relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg active:scale-98 bg-white/95 border-muted-200 hover:border-primary/20 rounded-lg">
