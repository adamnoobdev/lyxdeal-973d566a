...
const DealCardComponent = ({
  ...
  return (
    <Card className="group h-full overflow-hidden rounded-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-lg active:scale-98 bg-white border-muted-200 hover:border-primary/20">
